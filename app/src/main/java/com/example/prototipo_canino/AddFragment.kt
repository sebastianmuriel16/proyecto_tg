...
import com.example.prototipo_canino.databinding.FragmentAddBinding
...
class AddFragment : Fragment() {
        ...
        if(mPhotoSelectedUri != null){
            ...
            myStorageRef.putFile(mPhotoSelectedUri!!)
                ...
                .addOnFailureListener{
                    mainAux?.showMessage(R.string.post_message_post_fail)
                }
        }
    }
    ...
    private fun saveSnaPshot(key:String,url: String,title:String){
        ...
        mSnapshotsDatabaseRef.child(key).setValue(snapshot)
            .addOnSuccessListener {
                hideKeyboard()
                mainAux?.showMessage(R.string.post_succes)
